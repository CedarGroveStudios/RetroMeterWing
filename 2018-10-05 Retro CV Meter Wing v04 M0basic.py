# 2018-10-05 Retro CV Meter Wing v04 M0Basic.py
# Feather M0 Basic-based CV monitor with analog current meter output
...
# neg_led = pulseio.PWMOut(board.D9)  # negative red LED
...
# on-board DotStar as polarity indicator; low brightness
...
def hello_zone():  # play hello zone tune
    beep_on(880)  # A5
    beep_off(0.25)
    beep_on(932)  # A#5
    beep_off(0.25)
...
output_hold = 0.5  # number of seconds to hold position before repositioning
...
print("2018-10-05 Retro CV Meter Wing v04 M0Basic.py")
...
while True:
    ...
    print(scale_idx, "%0.2f" % cv_input_volt)
