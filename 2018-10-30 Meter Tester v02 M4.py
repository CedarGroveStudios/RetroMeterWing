# 2018-10-30 Meter Tester v02 M4.py
...
dac_resist = 99.7e3 # the PCB's series meter resistor value in ohms
test_volt = 0
probe_volt = 0

print("2018-10-30 Meter Tester v02 M4.py")
hello_A()

# splash screen
oled.text("Meter Tester v2", 0, 0)
oled.text("  Free:", 0, 8)
